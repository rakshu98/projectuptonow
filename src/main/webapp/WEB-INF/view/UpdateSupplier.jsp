...
<div class="container">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="text">Supplier Address:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="supaddr" name="supaddr" value="${supplierInfo.supplierAddress}"/>
    </div>
  </div>
